...
# что-либо с ним нельзя. Для нормальной работы аналитической программы берётся новый список, который равен тому, что пришло.
...
import random
original_prices = [random.randint(-99, 100) for _ in range(10)]
#original_prices = [-12, 3, 5, -2, 1]
